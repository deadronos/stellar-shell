...
- **Resources**:
    ...
    - **Rare Elements** (Advanced): Found in **Rare Ore** veins generated by geological/noise variation across asteroid mass (typically more rewarding in dense/deep mining routes). Used for advanced Sphere components.
...
### Phase 2: The Shell
- A solid shell for maximum energy capture. Requires Rare Elements sourced from asteroid Rare Ore veins.
